...
# TF graph input
x = tf.placeholder("float", [None, 784]) # mnist data 28x28
...
# Adds summary ops to collect data
...
with tf.Session() as sess:
    ...
    '/home/christian/git/ml/tensorflow/logs', sess.graph)
    ...
    for iteration in range(training_iteration):
        ...
        for i in range(total_batch):
            ...
            avg_cost += sess.run(cost_function,
